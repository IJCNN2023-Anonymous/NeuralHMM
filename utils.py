...
def data_extract(best_epoch_data, best_epoch):
    if best_epoch == None:
        h_gru = best_epoch_data[0]
        mu_q = best_epoch_data[1]
        var_q = best_epoch_data[2]
        batch_x = best_epoch_data[3]
        batch_y = best_epoch_data[4]
        batch_name = best_epoch_data[5]
    else:
        h_gru = best_epoch_data[best_epoch][0]
        mu_q = best_epoch_data[best_epoch][1]
        var_q = best_epoch_data[best_epoch][2]
        batch_x = best_epoch_data[best_epoch][3]
        batch_y = best_epoch_data[best_epoch][4]
        batch_name = best_epoch_data[best_epoch][5]
